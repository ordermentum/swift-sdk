#
#  Be sure to run `pod spec lint Ordermentum.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Brandon Stillitano"
  # s.authors            = { "Brandon Stillitano" => "brandon.stillitano@ordermentum.com" }
  # s.social_media_url   = "http://twitter.com/Brandon Stillitano"
  ...
  # ――― Swift Version ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
  #  Set the swift version that this library is written for.
