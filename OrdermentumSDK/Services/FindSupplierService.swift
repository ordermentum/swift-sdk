...
public class FindSupplierService {
     ...
     */
    public func getSuppliers(searchString: String, pageSize: Int, retailerId: String, completion: @escaping (Bool, FindSupplierResponse?, ErrorResponse?) -> Void) {
        //Build Route
     ...
     */
    public func sendSupplierEnquiry(_ requestObject: FindSupplierRequest, completion: @escaping (Bool, ErrorResponse?) -> Void) {
        //Build Route
     ...
     * Returns a response body which can be used to check for a 200 response
     */
    public func sendSupplierReferral(_ requestObject: FindSupplierReferralRequest, completion: @escaping (Bool, ErrorResponse?) -> Void) {
        //Build Route
