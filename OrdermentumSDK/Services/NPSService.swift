...
public class NPSService {
     ...
     */
    public func getNPS(completion: @escaping (Bool, NPSResponse?, ErrorResponse?) -> Void) {
        //Build Route
     ...
     */
    public func sendFeedback(_ requestObject: NPSFeedback, completion: @escaping (Bool, ErrorResponse?) -> Void) {
        //Build Route
